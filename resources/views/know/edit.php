...
<div id="all">
	...
	<FORM name="form1" method="POST" action="<?=site_url('/knowledge/update').'/'.$Kid?>" onsubmit="return check(this)" enctype="multipart/form-data">
	<div class="content">
		<div id="cen">
            ...
            <div>
                ...
                <div style="text-align:right; height:30px; line-height:30px;"><a href="register1.html"><font class="f15"><a href="<?=site_url('/knowledge')?>">回上頁</a></font></a></div>
			</div>
		</div>
	</div>
	</form>
...
function uknow(v){
    ...
    document.getElementById('que_pic').src="<?=site_url('/knowledge/qupload')?>?type="+v;
    $('#sets_filed').show();
    $('#loading_status').show();
